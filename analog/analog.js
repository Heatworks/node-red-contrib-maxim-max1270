...
module.exports = function(RED) {
    function MaximMax1270Node(config) {
        ...
        var args = []
        args = [0,1,parseInt(config.channel),parseInt(config.sampling),parseInt(config.reporting),parseInt(config.spiclk),parseInt(config.spidi),parseInt(config.spido),parseInt(config.spics)]
